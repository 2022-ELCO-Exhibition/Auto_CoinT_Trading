...
from lab.trader import data_manager

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--mode', choices=['train', 'test', 'update', 'predict'], default='train')
    parser.add_argument('--ver', choices=['v1'], default='v1')
    parser.add_argument('--name', default=utils.get_time_str())
    parser.add_argument('--stock_code', nargs='+')
    parser.add_argument('--rl_method', choices=['a2c'])
    parser.add_argument('--net', choices=['dnn', 'monkey'], default='dnn')
    ...
    from lab.trader.learners import ReinforcementLearner, ActorCriticLearner, A2CLearner
